...
// Converted to JSX directly to maintain zero-friction integration with your repository.
const DarkModeToggle = ({ isDark, onToggle }) => {
  return (
    <label className="relative inline-block w-[3.5em] h-[2em] text-[10px] sm:text-[12px] md:text-[14px]">
      {/* Hidden checkbox */}
      <input 
        type="checkbox" 
        checked={isDark} 
